...
@baseline_registry.register_obs_transformer()
class ResizeSquare(ObservationTransformer):
    r"""An nn module the resizes your input to a square.
    This module assumes that all images in the batch are of the same size.
    """
    ...
    @classmethod
    def from_config(cls, config: Config):
        return cls(config.RL.POLICY.OBS_TRANSFORMS.RESIZE_SQUARE.SIZE)
