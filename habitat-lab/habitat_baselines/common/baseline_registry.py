...
class BaselineRegistry(Registry):
    ...
    @classmethod
    def register_aux_task(cls, to_register=None, *,
        ...
        Args:
            name: Key with which the env will be registered.
                If None will use the name of the class.
        """
        from habitat_baselines.common.aux_tasks.aux_utils import \
            RolloutAuxTask
        return cls._register_impl("aux_task", to_register, name,
                                  assert_type=RolloutAuxTask)
