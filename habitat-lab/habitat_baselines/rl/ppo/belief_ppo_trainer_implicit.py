...
@baseline_registry.register_trainer(name="belief-ddppo-impl")
class BeliefPPOTrainerImpl(BaseRLTrainer):
    ...
    def _init_train(self):
        ...
        pg_temp = batch['pointgoal_with_gps_compass']
        batch['pointgoal_with_gps_compass'] = batch['pointgoal_with_gps_compass_single']
        batch['pointgoal_with_gps_compass_single'] = pg_temp
    ...
    def _compute_actions_and_step_envs(self, buffer_index: int = 0):
        ...
        with torch.no_grad():
            ...
            #new_batch = deepcopy(step_batch)
            #new_batch["observations"]['pointgoal_with_gps_compass'] = new_batch["observations"]['pointgoal_with_gps_compass_single']
    ...
    def _collect_environment_result(self, buffer_index: int = 0):
        ...
        pg_temp = batch['pointgoal_with_gps_compass']
        batch['pointgoal_with_gps_compass'] = batch[
            'pointgoal_with_gps_compass_single']
        batch['pointgoal_with_gps_compass_single'] = pg_temp
