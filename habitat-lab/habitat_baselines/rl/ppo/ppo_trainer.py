...
class PPOTrainer(BaseRLTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config) -> None:
        ...
        #debug
        #print(observation_space["semantic"])
        #raise Exception("")
        ...
        #observation_space = Dict({
                #k: v for k, v in observation_space.spaces.items() if k != "rgb" # and k != "semantic"
        #})
    ...
    def _update_agent(self):
        ...
        value_loss, action_loss, dist_entropy , _, _, _, _= self.agent.update(
            self.rollouts
        )
    ...
    def _training_log(
        ...
        #metric["reward"]=deltas["reward"] / deltas["count"]
        self.wandb_ctx.log(metrics)
