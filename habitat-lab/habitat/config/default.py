...
_C.TASK.POSSIBLE_ACTIONS = ["STOP", "MOVE_FORWARD", "TURN_LEFT", "TURN_RIGHT", "MOVE_BACKWARD"] #, "LOOK_UP"] #TODO
# -----------------------------------------------------------------------------
# # ACTIONS
# -----------------------------------------------------------------------------
ACTIONS = CN()
...
ACTIONS.MOVE_BACKWARD = CN()
ACTIONS.MOVE_BACKWARD.TYPE = "MoveBackwardAction"
...
ACTIONS.VELOCITY_CONTROL.NOISY_ACTUATION = False #True #True
...
_C.TASK.ODOMETRIC_GPS_COMPASS_SENSOR.TYPE = (
    "OdometricGpsCompassSensor"
)
# -----------------------------------------------------------------------------
# OBJECTGOAL SENSOR
# -----------------------------------------------------------------------------
...
# ABSOLUTE GPS SENSOR
# -----------------------------------------------------------------------------
_C.TASK.AGPS_SENSOR = CN()
_C.TASK.AGPS_SENSOR.TYPE = "AGPSSensor"
_C.TASK.AGPS_SENSOR.DIMENSIONALITY = 3
# -----------------------------------------------------------------------------
# ABSOLUTE ROTATION SENSOR
# -----------------------------------------------------------------------------
_C.TASK.AROT_SENSOR = CN()
_C.TASK.AROT_SENSOR.TYPE = "ARotSensor"
# -----------------------------------------------------------------------------
# PROXIMITY SENSOR
# -----------------------------------------------------------------------------
...
_C.SIMULATOR.ACTION_SPACE_CONFIG = "v0"  #"pyrobotnoisysoc"
#_C.SIMULATOR.NOISE_MODEL = CN()
#_C.SIMULATOR.NOISE_MODEL.ROBOT = "LoCoBot"
#_C.SIMULATOR.NOISE_MODEL.CONTROLLER = "Movebase"
...
#_C.SIMULATOR.RGB_SENSOR.NOISE_MODEL = "GaussianNoiseModel"
#_C.SIMULATOR.RGB_SENSOR.NOISE_MODEL_KWARGS = CN()
#_C.SIMULATOR.RGB_SENSOR.NOISE_MODEL_KWARGS.INTENSITY_CONSTANT = 0.5
# -----------------------------------------------------------------------------
# DEPTH SENSOR
# -----------------------------------------------------------------------------
...
#_C.SIMULATOR.DEPTH_SENSOR.NOISE_MODEL = "RedwoodDepthNoiseModel"
# -----------------------------------------------------------------------------
# SEMANTIC SENSOR
# -----------------------------------------------------------------------------
...
_C.SIMULATOR.AGENT_0.HEIGHT = 0.88 #1.5
_C.SIMULATOR.AGENT_0.RADIUS = 0.10 #0.10
...
_C.SIMULATOR.HABITAT_SIM_V0.ALLOW_SLIDING = True #True
...
#gfx_replay
_C.SIMULATOR.HABITAT_SIM_V0.ENABLE_GFX_REPLAY_SAVE = True

_C.SIMULATOR.NUM_PEOPLE = 1  #0
