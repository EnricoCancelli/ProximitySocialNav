...
def observations_to_image(observation: Dict, info: Dict) -> np.ndarray:
    ...
    # draw risk value
    #if "risk" in observation:
     #   egocentric_view = append_text_to_image(egocentric_view, "risk"+str(observation["risk"].item()))

    #if "social_compass" in observation:
      #  egocentric_view = append_text_to_image(egocentric_view, "social_compass"+str(list(observation["social_compass"])))
